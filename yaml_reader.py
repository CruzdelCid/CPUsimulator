...
bios = yaml.safe_load(open('bios.yaml'))

if bios['visualization']['Radix']=='bin' :
    print(bin(25))

if bios['visualization']['Radix']=='oct' :
    print(oct(25))

if bios['visualization']['Radix']=='hex' :
    print(hex(25))

bios['RAM']['instructions'].append("0001 0111") ##llenar lista instrucciones, ejemplo
